...
MAN_FRACTALS=$(MAN_SRCS_DIR)fractal/fractal_utils.c $(MAN_SRCS_DIR)fractal/fractal_utils_recurrence.c $(MAN_SRCS_DIR)fractal/fractal_utils_execute.c $(MAN_SRCS_DIR)fractal/fractal3d_utils_recurrence.c $(MAN_SRCS_DIR)fractal/logistic_utils.c $(MAN_SRCS_DIR)fractal/julia3d_utils.c $(MAN_SRCS_DIR)fractal/mandelbrot.c $(MAN_SRCS_DIR)fractal/julia.c $(MAN_SRCS_DIR)fractal/burningship.c $(MAN_SRCS_DIR)fractal/tricorn.c $(MAN_SRCS_DIR)fractal/logistic_map.c $(MAN_SRCS_DIR)fractal/mandelbrot3d.c $(MAN_SRCS_DIR)fractal/julia3d.c $(MAN_SRCS_DIR)fractal/fractal3d_utils.c $(MAN_SRCS_DIR)fractal/fractal3d_utils_init.c $(MAN_SRCS_DIR)fractal/fractal3d_utils_matrix.c $(MAN_SRCS_DIR)fractal/mandelbrot3d_utils.c $(MAN_SRCS_DIR)fractal/burningship3d.c $(MAN_SRCS_DIR)fractal/fractal3d_utils_stereographic_projection.c
...
BONUS_FRACTALS=$(BONUS_SRCS_DIR)fractal/fractal_utils_bonus.c $(BONUS_SRCS_DIR)fractal/fractal_utils_recurrence_bonus.c $(BONUS_SRCS_DIR)fractal/fractal_utils_execute_bonus.c $(BONUS_SRCS_DIR)fractal/fractal3d_utils_recurrence_bonus.c $(BONUS_SRCS_DIR)fractal/logistic_utils_bonus.c $(BONUS_SRCS_DIR)fractal/julia3d_utils_bonus.c $(BONUS_SRCS_DIR)fractal/mandelbrot_bonus.c $(BONUS_SRCS_DIR)fractal/julia_bonus.c $(BONUS_SRCS_DIR)fractal/burningship_bonus.c $(BONUS_SRCS_DIR)fractal/tricorn_bonus.c $(BONUS_SRCS_DIR)fractal/logistic_map_bonus.c $(BONUS_SRCS_DIR)fractal/mandelbrot3d_bonus.c $(BONUS_SRCS_DIR)fractal/julia3d_bonus.c $(BONUS_SRCS_DIR)fractal/fractal3d_utils_bonus.c $(BONUS_SRCS_DIR)fractal/fractal3d_utils_init_bonus.c $(BONUS_SRCS_DIR)fractal/fractal3d_utils_matrix_bonus.c $(BONUS_SRCS_DIR)fractal/mandelbrot3d_utils_bonus.c $(BONUS_SRCS_DIR)fractal/burningship3d_bonus.c $(BONUS_SRCS_DIR)fractal/fractal3d_utils_stereographic_projection_bonus.c
