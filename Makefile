...
MAN_UIS=$(MAN_SRCS_DIR)ui/ui_init_screen.c $(MAN_SRCS_DIR)ui/ui_key.c $(MAN_SRCS_DIR)ui/ui_mouse.c $(MAN_SRCS_DIR)ui/ui_button.c $(MAN_SRCS_DIR)ui/ui_button_execute.c $(MAN_SRCS_DIR)ui/ui_menu.c $(MAN_SRCS_DIR)ui/ui_theme.c
MAN_FRACTALS=$(MAN_SRCS_DIR)fractal/fractal_utils.c $(MAN_SRCS_DIR)fractal/fractal_utils_recurrence.c $(MAN_SRCS_DIR)fractal/fractal_utils_execute.c $(MAN_SRCS_DIR)fractal/logistic_utils.c $(MAN_SRCS_DIR)fractal/mandelbrot.c $(MAN_SRCS_DIR)fractal/julia.c $(MAN_SRCS_DIR)fractal/burningship.c $(MAN_SRCS_DIR)fractal/tricorn.c $(MAN_SRCS_DIR)fractal/logistic_map.c
