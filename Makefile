...
MAN_FRACTALS=$(MAN_SRCS_DIR)fractal/fractal_utils.c $(MAN_SRCS_DIR)fractal/fractal_utils_recurrence.c $(MAN_SRCS_DIR)fractal/fractal_utils_execute.c $(MAN_SRCS_DIR)fractal/fractal3d_utils_recurrence.c $(MAN_SRCS_DIR)fractal/logistic_utils.c $(MAN_SRCS_DIR)fractal/julia3d_utils.c $(MAN_SRCS_DIR)fractal/mandelbrot.c $(MAN_SRCS_DIR)fractal/julia.c $(MAN_SRCS_DIR)fractal/burningship.c $(MAN_SRCS_DIR)fractal/tricorn.c $(MAN_SRCS_DIR)fractal/logistic_map.c $(MAN_SRCS_DIR)fractal/mandelbrot3d.c $(MAN_SRCS_DIR)fractal/julia3d.c $(MAN_SRCS_DIR)fractal/fractal3d_utils.c $(MAN_SRCS_DIR)fractal/fractal3d_utils_matrix.c $(MAN_SRCS_DIR)fractal/mandelbrot3d_utils.c
